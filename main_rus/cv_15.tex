...
\includegraphics[width=0.6\columnwidth]{v1.jpg}\\[\baselineskip] % Your photo
\small % Smaller font size
Пискотин Александр Александрович\\ % Your name
27.04.1998 \\
\Sep
\url{aapiskotin@gmail.com} \\ % Your email address
% \url{www.johnsmith.com} \\ % Your URL % Don't need theeese
+7 (901) 703-74-82 \\ % Your phone number
Telegram,  WhatsApp \\
\Sep % Some whitespace
г.  Москва \\
% \textbf{Address} \\ %Don't really think I need an address in cv
...
\cvheading{Пискотин Александр} % Large heading - your name
...
\aboutme{О себе}{Работаю в DS уже второй год.  За это время приобрел интересный и очень разнообразный опыт работы с данными. Имею опыт работы при различных условиях построения процессов работы отдела аналитики. Также интересуюсь построением процессов работы DS команды, как с технической (DevOps, MLOps), так и с продуктовой точки зрения (Product Management, LeanDS)}
...
\CVItem{2016 - WIP,  НИЯУ МИФИ}{ИФТИС,  Электроника и автоматика физических установок}

%------------------------------------------------

\CVItem{2019,  Техноатом (очный курс от Mail.Ru)}{Прикладной Python (Трек: Machine Learning)}

%------------------------------------------------

\CVItem{2019,  Техноатом (очный курс от Mail.Ru)}{Базовый курс по нейронным сетям}

%------------------------------------------------

\CVItem{2020,  Техноатом (очный курс от Mail.Ru)}{Продуктовая аналитика}

%------------------------------------------------

\CVItem{2021,  Школа аналитиков X5}{}
